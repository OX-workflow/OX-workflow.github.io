...
const copy = {
  en: {
    ...
    topologyTag:"05 / Network state", topologyTitleA:"The network can", topologyTitleB:"disappear.",
    ...
    syncTag:"06 / Synchronization", syncTitleA:"Synchronization is", syncTitleB:"reconciliation, not transport.",
    ...
    durabilityTag:"07 / Durable state & event history", durabilityTitleA:"State tells you", durabilityTitleB:"what is true.",
    ...
    authorityTag:"08 / Authority model", authorityTitleA:"Data movement", authorityTitleB:"does not grant authority.",
    ...
    conflictTag:"09 / Conflict handling", conflictTitleA:"Independent changes", conflictTitleB:"must become explicit.",
    ...
    deliveryTag:"10 / Outbox · replay · idempotency", deliveryTitleA:"Reliable delivery", deliveryTitleB:"needs durable boundaries.",
    ...
    auditTag:"11 / Auditability", auditTitleA:"The system should answer", auditTitleB:"what happened.",
    ...
    statusTag:"12 / Implementation status", statusTitleA:"Architecture claims", statusTitleB:"stay explicit.",
    ...
    ctaTag:"13 / Continue", ctaTitleA:"From architecture", ctaTitleB:"to operational scenarios.", ctaBody:"See how these boundaries map onto real environments, or return to the platform lifecycle.", solutions:"View solutions", product:"View product",
  ...
  fa: {
    ...
    languageTag:"۰۳ / حلقه · مدار · شبکه · سیگنال",
    languageTitleA:"هویت بصری",
    languageTitleB:"به معماری نگاشت می‌شود.",
    languageBody:"همان زبان چهارگانه برای توصیف رفتار سامانه به کار می‌رود: اختیار پیرامون اجرا، هماهنگی میان کپی‌ها، ساختار وضعیت عملیاتی و سیگنال‌های زنده از رویدادها و شواهد.",
    languageItems:[
      ["حلقه","اختیار","اجرای کنترل‌شده","مرزهای هویت و اختیار مشخص می‌کنند چه اقداماتی مجاز هستند."],
      ["مدار","هماهنگی","همگام‌سازی","کپی‌ها، مشارکت‌کنندگان و تطبیق، عملیات توزیع‌شده را به هم متصل می‌کنند."],
      ["شبکه","ساختار","وضعیت عملیاتی","وضعیت پایدار، چرخه عمر، روابط، سیاست‌ها و تاریخچه، بستر ساختاری عملیات هستند."],
      ["سیگنال","آگاهی","رویدادها + شواهد","رویدادها، ممیزی و شواهد عملیاتی نشان می‌دهند چه چیزی تغییر کرده و چه چیزی قابل بازسازی است."],
    ],
