...
const copy = {
  en: {
    ...
    states:[["متصل","Coordinate + synchronize","The node exchanges state and participates in the shared operational view."],["مختل","Continue + queue","Local execution continues while synchronization capacity is constrained."],["قطع","Execute + preserve","The node operates against its available state and preserves outcomes for later reconciliation."],["بازیابی‌شده","Reconcile + verify","Connectivity returns and distributed changes are brought back together under system rules."]],
    ...
    futureBody:"The future هوش مصنوعی عامل‌محور / افزونه layer should sit above the operational model rather than bypass it. Agents can propose, inspect, coordinate, or trigger governed actions while the same authority, state, and verification boundaries remain in force.",
    ...
    statuses:[["مستند","Operating model","Local-first execution, synchronization, authority, and verification are the architectural model presented by ONYX."],["در حال توسعه","Platform components","Implementation details should be tracked against the roadmap rather than inferred from this diagram."],["برنامه‌ریزی‌شده","Agent interface","هوش مصنوعی عامل‌محور / افزونه integration is a future layer and is explicitly separated from the current product model."]],
