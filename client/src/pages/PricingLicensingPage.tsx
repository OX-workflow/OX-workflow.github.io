...
const copy = {
  en: {
    ...
    intro:"ONYX is positioned for hosted subscription, self-managed enterprise licensing, and customized enterprise editions. The commercial model is designed to separate software rights, deployment rights, support, and customer-specific work instead of collapsing them into a single generic price.",
