...
const copy = {
  ...
  fa: {
    ...
    primary:"مشاهده محصول", secondary:"درخواست دمو", home:"بازگشت به خانه", language:"English", light:"حالت روشن", dark:"حالت تاریک",
    ...
    conditions:[
      ["CONNECTED","هماهنگی","از اتصال موجود برای همگام‌سازی وضعیت و هماهنگی تیم‌ها استفاده کنید."],
      ["DEGRADED","ادامه","در حالی که ظرفیت ارتباط محدود است، کار محلی را در دسترس نگه دارید."],
      ["OFFLINE","حفظ","با وضعیت موجود اجرا کنید و نتایج را برای تلفیق حفظ کنید."],
      ["RESTORED","تلفیق","تغییرات توزیع‌شده را طبق قواعد صریح همگام‌سازی دوباره یکپارچه کنید."],
    ],
