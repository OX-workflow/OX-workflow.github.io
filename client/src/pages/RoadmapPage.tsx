...
const copy = {
  en: {
    ...
    nowItems: [
      ["محلی‌محور", "Continue operating when connectivity is degraded or unavailable."],
    ...
    horizonItems: [
      ["عملیات فدره", "Explore controlled interoperability between independently governed operational domains."],
      ["رابط‌های عامل و افزونه", "Research governed automation interfaces that inherit identity, authorization, state, and audit boundaries."],
    ...
    statuses: [
      ["فعلی", "Foundation capabilities and architecture that define the present ONYX operating model."],
      ["برنامه‌ریزی‌شده", "Expansion areas that are part of the product direction but should not be represented as generally shipped."],
      ["پژوهشی", "Exploratory federation and automation directions requiring further architecture, security, and deployment validation."],
    ],
